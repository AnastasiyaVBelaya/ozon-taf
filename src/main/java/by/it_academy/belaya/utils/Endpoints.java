...
public class Endpoints {
    ...
    public static final String BASE_SEARCH_URL = "https://ozon.by/";
    public static final String BASE_LOGIN_URL = "https://ozon.ru/";
    ...
    public static final String LOGIN = "api/composer-api.bx/_action/fastEntryV3";
    public static String getSearchUrl(String path) {
        return BASE_SEARCH_URL + path;
    }
    public static String getLoginUrl(String path) {
        return BASE_LOGIN_URL + path;
    }
}
